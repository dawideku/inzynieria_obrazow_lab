...
def ssaa(image, scale=2):
    ...
    v1 = (200 * scale, 180 * scale)
    v2 = (150 * scale, 250 * scale)
    draw_filled_triangle_interpolated(work_image, v0, (255, 0, 0), v1, (0, 255, 0), v2, (0, 0, 255))

    result_image = work_image.resize((width, height), Image.LANCZOS)
